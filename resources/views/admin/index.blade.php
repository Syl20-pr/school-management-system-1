...
@section('admin')
  ...
  <div class="content-wrapper">
	...
	<div class="box-body">							
		...
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Frais Scolaire</p>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Frais de Carte</p>
			<h3 class="text-white mb-0 font-weight-500">3400 <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
		</div>
	</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Frais Mensuels</p>
...
<div class="box">
	<div class="box-header">
		<h4 class="box-title align-items-start flex-column">
			Nouveautés
			<small class="subtitle">Plus de 400+ Nouveaux Membres</small>
		</h4>
	</div>
	<div class="box-body">
			...
			<table class="table no-border">
				<thead>
					<tr class="text-uppercase bg-lightest">
						...
						<th style="min-width: 100px"><span class="text-fade">Flooz/TMoney</span></th>
						<th style="min-width: 100px"><span class="text-fade">dépot</span></th>
						<th style="min-width: 150px"><span class="text-fade">agent</span></th>
						<th style="min-width: 130px"><span class="text-fade">statut</span></th>
	 ...
	 <div class="bg-img h-50 w-50" style="background-image: url(../images/gallery/creative/img-1.jpg)"></div>
						...
						<td>
							<span class="badge badge-primary-light badge-lg">Apprové</span>
						</td>
						<td class="text-right">
					...
					<tr>										
						...
						<td>
							<span class="badge badge-warning-light badge-lg">En Cours</span>
						</td>
						<td class="text-right">
							<a href="#" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-bookmark-plus"></span></a>
							<a href="#" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-arrow-right"></span></a>
					...
					<tr>										
						...
						<td>
							<span class="badge badge-success-light badge-lg">Succès</span>
						</td>
						<td class="text-right">
							<a href="#" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-bookmark-plus"></span></a>
							<a href="#" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-arrow-right"></span></a>
					...
					<tr>										
						...
						<td>
							<span class="badge badge-danger-light badge-lg">Rejeté</span>
						</td>
						<td class="text-right">
							<a href="#" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-bookmark-plus"></span></a>
							<a href="#" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-arrow-right"></span></a>
