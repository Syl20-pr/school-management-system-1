...
<div class="box bb-3 border-warning">
				  <div class="box-header">
					<h4 class="box-title">Ajouter<strong> Des Frais Scolaire </strong></h4>
				  </div>
...
<div class="col-md-3">
 		 ...
 		 <div class="form-group">
		<h5>Catégorie de Frais<span class="text-danger"> </span></h5>
		<div class="controls">
 <select name="fee_category_id" id="fee_category_id"  required="" class="form-control">
			<option value="" selected="" disabled="">Sélectionner Une Catégories de Frais</option>
...
<div id="DocumentResults">
 ...
 <button type="submit" class="btn btn-primary" style="margin-top: 10px">Payer</button>  
