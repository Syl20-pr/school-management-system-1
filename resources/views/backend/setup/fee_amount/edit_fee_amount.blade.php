		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Modifier le Montant des Frais</h4>
 ...
 <form method="post" action="{{ route('update.fee.amount',$editData[0]->fee_category_id) }}">
	...
	<div class="controls">
	 <select name="fee_category_id" required="" class="form-control">
		<option value="" selected="" disabled="">Sélectionner Une Catégorie de Frais</option>
  ...
  <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
   ...
   <div class="form-group">
	<h5>Classe de l'Éleve <span class="text-danger">*</span></h5>
	<div class="controls">
