...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Modifier Les Notes de Grades  </h4>
 ...
 <form method="post" action="{{ route('update.marks.grade',$editData->id) }}"  >
		...
		<h5>Nom de La Grade <span class="text-danger">*</span></h5>
		<div class="controls">
 <input type="text" name="grade_name" class="form-control" required="" value="{{ $editData->grade_name }}" > 
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Point de La Grade <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Notes de Début <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Notes De Fin <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 	 ...
 	 <div class="form-group">
		<h5>Point de Début <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Point de Fin <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="row"> <!-- 3rd Row -->
 		...
 		<div class="form-group">
		<h5>Remarques <span class="text-danger">*</span></h5>
		<div class="controls">
