...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Ajouter Des Notes De Grades  </h4>
	 ...
	 <form method="post" action="{{ route('store.marks.grade') }}"  >
		...
		<h5>Nom de Grade <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Points de Grade <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Note De Début <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Note De Fin <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 	 ...
 	 <div class="form-group">
		<h5> Points De Début <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Points De Fin <span class="text-danger">*</span></h5>
		<div class="controls">
