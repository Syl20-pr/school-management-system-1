...
<table id="customers">
  <tr>
    <td colspan="2" style="text-align: center;">
      <h4>Date de Rapport: {{ date('d M Y', strtotime($sdate) ) }} - {{ date('d M Y', strtotime($edate) ) }}</h4>

    </td>
  </tr>
  <tr>
    <td width="50%"><h4>Motif</h4></td>
    <td width="50%"><h4>Montant</h4></td>
     
  </tr>
  <tr>
    <td>Frais de Scolarités </td>
    <td> {{ $student_fee }}</td>
    
  </tr>

    <tr>
    <td>Salaires Des Employé(e)s </td>
    <td> {{ $emp_salary }} </td>
