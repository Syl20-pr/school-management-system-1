...
<head>
    ...
    <title>Frais Mensuels de l'Élève</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-info">
            ...
            <p><b> Frais Mensuels</b></p>
        </div>
    </div>

    <!-- Student Fee Details -->
    @php 
    $registrationfee = App\Models\FeeCategoryAmount::where('fee_category_id','6')
