		 ...
		 <!-- Basic Forms --> 
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Mettre à Jour l'Utilisateur</h4>
...
<div class="row">
	...
	<h5>Rôle de l'Utilisateur <span class="text-danger">*</span></h5>
	<div class="controls">
 ...
 <!--<option value="User" {{ ($editData->usertype == "User" ? "selected": "") }} >Utilisateur</option>-->
  <option value="Operator" {{ ($editData->role == "Operator" ? "selected": "") }} >Opérateur</option> 
	...
	<div class="col-md-6" >		
	<div class="form-group">
		<h5>Nom d'Utilisateur <span class="text-danger">*</span></h5>
		<div class="controls">
