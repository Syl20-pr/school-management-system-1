...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Gestion du Profil</h4>
	...
	<div class="col-md-6" >
		...
		<h5>Nom de l'Utilisateur <span class="text-danger">*</span></h5>
		<div class="controls">
 ...
 <div class="form-group">
		<h5>E-mail de l'Utilisateur<span class="text-danger">*</span></h5>
		<div class="controls">
 ...
 <div class="row">
	<div class="col-md-6" >
		...
		<div class="form-group">
		<h5>Numéro de Téléphone de l'Utilisateur <span class="text-danger">*</span></h5>
		<div class="controls">
 ...
 <div class="form-group">
		<h5>Adresse de l'Utilisateur<span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="row">
 ...
 <option value="Feminin" {{ ($editData->gender == "Feminin" ? "selected": "") }} >Féminin</option>
