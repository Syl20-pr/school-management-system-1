...
<div class="box box-widget widget-user">
 ...
 <div class="widget-user-header bg-black">
	  <h3 class="widget-user-username">Nom d'Utilisateur : {{ $user->name }}</h3>
	   ...
	   <a href="{{ route('profile.edit') }}" style="float: right;" class="btn btn-rounded btn-success mb-5"> Modifier Votre Profil</a>	
	  
	  <h6 class="widget-user-desc">Type d'Utilisateur : {{ $user->usertype }}</h6>
