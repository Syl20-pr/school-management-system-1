...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Ajouter une présence </h4>
   ...
   <th colspan="3" class="text-center" style="vertical-align: middle; width: 30%">Statut</th>				
   				</tr>
...
<input name="attend_status{{$key}}" type="radio" value="Présent" id="present{{$key}}" checked="checked">
 <label for="present{{$key}}">Present</label>

 <input name="attend_status{{$key}}" value="Permission" type="radio" id="leave{{$key}}"  >
