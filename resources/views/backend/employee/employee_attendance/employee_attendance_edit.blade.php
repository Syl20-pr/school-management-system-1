...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Modification</h4>
   ...
   <th colspan="3" class="text-center" style="vertical-align: middle; width: 30%">Status</th>				
   	...
   	<tr>
   		...
   		<th class="text-center btn leave_all" style="display: table-cell; background-color: #000000">Permission</th>
...
<input name="attend_status{{$key}}" type="radio" value="Présent" id="present{{$key}}" checked="checked" {{ ($data->attend_status == 'Présent')?'checked':'' }} >
 <label for="present{{$key}}">Présent</label>

 <input name="attend_status{{$key}}" value="Permission" type="radio" id="leave{{$key}}"  {{ ($data->attend_status == 'Permission')?'checked':'' }}  >
 <label for="leave{{$key}}">Permission</label>
