...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Modification de l'Inscription de l'Employé(e) </h4>
	...
	<div class="col-md-4">
	 ...
	 <select name="gender" id="gender" required="" class="form-control">
			...
			<option value="Masculin" {{ ($editData->gender == 'Masculin')? 'selected': '' }} >Masculin</option>
			<option value="Féminin" {{ ($editData->gender == 'Féminin')? 'selected': '' }}>Féminin</option>
...
<div class="col-md-4">
	...
	<option value="Animiste" {{ ($editData->religion == 'Animiste')? 'selected': '' }}>Animiste</option>
	<option value="Chrétien" {{ ($editData->religion == 'Chrétien')? 'selected': '' }}>Chrétien</option>
	<option value="S'Abstenir" {{ ($editData->religion == 'S\'Abstenir')? 'selected': '' }}>S'Abstenir</option>
	 ...
	 <input type="date" name="dob" class="form-control" required="" value="{{ $editData->dob }}"  > 
		...
		<div class="controls">
	 <input type="text" name="lob" class="form-control" required="" value="{{ $editData->lob }}"> 
	  </div>		 
	  </div>
...
@endif
		...
		<div class="controls">
	 <input type="text" name="f_no" class="form-control" required="" value="{{ $editData->f_no }}"> 
	  </div>		 
	  </div>
	 ...
	 <select name="role" id="role" required="" class="form-control">
			...
			<option value="enseignant" {{ ($editData->religion == 'enseignant')? 'selected': '' }}>Enseignant</option>
			<option value="sécrétaire" {{ ($editData->religion == 'sécrétaire')? 'selected': '' }}>Sécrétaire</option>
			<option value="agent de sécurité" {{ ($editData->religion == 'agent de sécurité')? 'selected': '' }}>Agent de sécurité</option>
			<option value="autres" {{ ($editData->religion == 'autres')? 'selected': '' }}>Autres</option>
